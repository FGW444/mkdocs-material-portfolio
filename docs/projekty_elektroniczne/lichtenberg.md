...
```mermaid
graph LR
A(Transformator podłączony <br>do zasilania 230V <br> z bezpiecznikiem <br>topikowym 10A /250V<br>na uzwojeniu pierwotnym) --> B(Ustawienie zacisku pierwszej <br>sondy na wypalanym <br>materiale oraz przyłożenie <br>drugiej sondy punktowej<br>z uzwojenia wtórnego<br>do wypalanego materiału) --> C(Pokrycie materiał wypalany <br>roztworem z sodą w celu <br>ułatwienia przewodzenia <br>prądu) --> D(Rozpoczęcie pracy przez <br>zamknięcie obwodu <br>naciskając wyłacznik 'NC'<br>ciągły czas wypalania <br>nie powinien być dłuższy <br>niż 45sekund) 
```
**Prototyp generatora:**

![moje zdjecie](../img-and-mp4/projekty_wlasne/lightenberg-collage1.png){ width="100%" style="display: block; margin: 0 auto;" }



| <center>Wyjaśnienie konstrukcji: |
| --- | 
...
![moje zdjecie](../img-and-mp4/projekty_wlasne/piorun-collage1.png){ width="100%" style="display: block; margin: 0 auto;" }
